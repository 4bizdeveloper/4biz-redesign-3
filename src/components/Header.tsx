...
export default function Header() {
  ...
  // Hamburger lines — colour adapts to header state
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          {/* Right side — desktop + mobile share one button, desktop also shows CTA */}
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            {/* Asymmetrical hamburger — shared across all breakpoints */}
            <button
      ...
      >
        ...
        >
          ...
          {/* ── Nav links ── */}
          <nav
            className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-1 sm:gap-2 md:gap-4
              text-left border-b border-white/10 pb-6 sm:pb-8 mt-2 sm:mt-4"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 pt-6 sm:pt-8 pb-10 sm:pb-12
            ...
            <div className="space-y-2 sm:space-y-3 sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex flex-wrap gap-4 sm:gap-5 items-center pt-1">
                ...
                {/* Facebook */}
                <a href="https://www.facebook.com/4bizglobal" target="_blank" rel="noopener noreferrer"
                  className={iconClass} aria-label="Facebook">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/4biz_ae" target="_blank" rel="noopener noreferrer"
                  className={iconClass} aria-label="Instagram">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/company/4biz-international/" target="_blank" rel="noopener noreferrer"
                  className={iconClass} aria-label="LinkedIn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                {/* X / Twitter */}
                <a href="https://x.com/4biz123" target="_blank" rel="noopener noreferrer"
                  className={iconClass} aria-label="X (formerly Twitter)">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                {/* YouTube */}
                <a href="https://www.youtube.com/@4bizinternationalae" target="_blank" rel="noopener noreferrer"
                  className={iconClass} aria-label="YouTube">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
